...
[[ImageSource]] represents the source bitmap and contains the logic for loading that image from a file. You can thing of this as the file representation in Excalibur for the image. Use [Sprites](/docs/sprites) to draw them to the screen.
