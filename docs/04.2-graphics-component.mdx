...
The graphics component allows flipping all the graphics at once without modifying the original graphics.

```typescript
actor.graphics.add('walk', leftAnimation)
actor.graphics.show('walk') // display the graphic
// flip the graphics to go right
...
- `flipHorizontal`
  ...
  - Flips all the graphics in the component horizontally

- `flipVertical`

  - Flips all the graphics in the component vertically
