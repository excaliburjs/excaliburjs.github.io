...
Collision groups provide an efficient way optimized in Excalibur to sort colliders into possible colliders.
...
![Example image of our rules](08-collision-groups/collision-filtering.jpg)
