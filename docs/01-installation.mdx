...
You can also download the raw Javascript files from the [Excalibur repository](https://github.com/excaliburjs/excalibur/releases).

<Note>

Remember, Excalibur is a client-side library and cannot be used in a
server-side Node.js
