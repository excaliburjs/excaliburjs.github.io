...
- They can help with _tree shaking_, as described in [this relatively beginner-friendly developers.google tutorial](https://developers.google.com/web/fundamentals/performance/optimizing-javascript/tree-shaking/#finding_opportunities_to_shake_a_tree).
...
[Screenshot demonstrating IntelliSense](/02.1-bundlers/intellisense_screenshot.png)
