...
- Invoking [[ScreenElement.contains]] will check against [screen coordinates](/docs/intro#screen-coordinates) by default.
...
Do not forget to set [PointerScope.Canvas](https://excaliburjs.com/docs/api/edge/enums/_input_pointer_.pointerscope.html#canvas), otherwise Excalibur will capture all mouse input and HTML GUI won't work properly.
