...
[[Graphics]] have a number of useful features that work for ALL types of graphics:
...
For drawing hooks the `ExcaliburGraphicsContext` is replacing the browser `CanvasRenderingContext2D`. If you need to do some custom drawing using the `CanvasRenderingContext2D`, you can use the new [`Canvas`](https://excaliburjs.com/docs/api/edge/classes/Canvas.html) graphic.
