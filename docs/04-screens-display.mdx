...
Sometimes you might want to switch between two different resolutions and viewports, perhaps for different scenes, or for some in-game animation. This can be done with [[Screen.pushResolutionAndViewport]] and [[Screen.popResolutionAndViewport]].
