...
In this tutorial, we are using "ES Style" imports, the global `ex.` namespace can also be used, which works well when doing a [standalone script](/docs/installation#script-reference-or-download).
...
See [notes about ES imports](/docs/bundlers) with module loaders and bundlers.

</Note>

## Build Your Game Script

Create a script in your project, here I’ve named it `game.ts`. Excalibur games are built off of the [Engine](/docs/intro) container. It is important to start the engine once you are done building your game.
...
Include your compiled game.js script after the excalibur script.
...
That’s cool, but let’s make something more interesting on the screen. TLDR [GitHub repo of this example](https://github.com/excaliburjs/sample-breakout)
...
// Use circcle collider with radius 10
