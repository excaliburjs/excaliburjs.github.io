/*! Excalibur - v0.1.1-alpha - 2013-12-19
...
(function (Util) {
    ...
    function buildExtend(superClazz) {
        var extendMethod = function extend(methods) {
            var subclass = function () {
                this['__super'].apply(this, Array.prototype.slice.call(arguments, 0));
                if (this['init']) {
                    this['init'].apply(this, Array.prototype.slice.call(arguments, 0));
...
;
//# sourceMappingURL=Excalibur-0.1.1-alpha.js.map
